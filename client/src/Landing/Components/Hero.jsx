...
import { ArrowRight, BookOpen, Play, CheckCircle, Users, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              Empowering Students Through <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-purple-500">Quality Education</span> & Expert Guidance
            </motion.h1>
            ...
            >
              KRJ (Knowledge Raising Junction) is a modern coaching institute committed to academic excellence, structured learning, and student-focused growth — <span className="text-gray-900 font-medium">supported by smart digital management.</span>
            </motion.p>
            ...
            >
              ...
              <motion.button
                whileHover={{ backgroundColor: '#ffffff', borderColor: '#9333ea' }}
                whileTap={{ scale: 0.97 }}
            ...
            {/* Trust Metrics */}
            <motion.div variants={fadeInUp} className="mt-10 flex items-center gap-8 text-gray-500 text-sm font-medium">
             ...
             >
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <p className="text-sm font-bold text-gray-900">120 Students</p>
                   </div>
                </div>
             </motion.div>
